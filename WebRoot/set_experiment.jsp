...
<form id="idFormList" name="formList" method="post" action="">
  <div class="filter_bar" style="width:99%;margin:1px;text-align:left;">
    <span style="color:white;width:55%;text-align:left;padding-left:5px">
        <span style="color:blue">当前位置：</span>首页 >> 预约实验 >> 设置实验室信息</span>
    <span style="width:43%;text-align:right;">
        <input style="font-size:12pt;width:80px;padding:3px" type="button" value="查询" onclick="Cmd(2);"/>
	    <input style="font-size:12pt;width:80px;padding:3px" type="button" value="提交" onclick="Cmd(1);"/>
	    <input style="font-size:12pt;width:80px;padding:3px" type="button" value="退出" onclick="Cmd(1);"/>
	</span>
  </div>
</form>
<table id="table1" width="99%" border="0" cellspacing="1" cellpadding="0" bgcolor="#ffffff" class="list" style="margin:1px;display:none;">
  ...
  <tr>
    ...
    <td width="25%">${laboratory.starttime}</td>
    <td width="25%">${laboratory.endtime}</td>
    <td width="25%"><input style="font-size:12pt;width:80px;padding:3px" type="button" value="上传"/></td>
  </tr>
  </c:forEach>  
</table>
...
<table id="table2" width="99%" border="0" cellspacing="1" cellpadding="0" bgcolor="#ffffff" class="list" style="margin:1px;display:none;">
    	...
    	<td width="18%">实验室ID:</td><td width="73%"><input name="username" type="text" class="Userbox1" id="username" value="" /></td>
    	</tr>
    	<tr>
